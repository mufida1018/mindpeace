            ...
            child: Column(
              children: [
                ...
                DelayedDisplay(
                  ...
                  child: Text('Hi ${widget.name} !!', style: kTitleTextStyle.copyWith(color: Colors.white),),
                ...
                DelayedDisplay(
                  ...
                  slidingBeginOffset: Offset(0, 2),
                  child: Text("Final step before we move ahead",textAlign: TextAlign.center ,style: kTitleTextStyle.copyWith(color: Colors.white.withOpacity(0.5), fontSize: 18),),
                  fadingDuration: Duration(milliseconds: 700),
                  fadeIn: true,
                ),
                Padding(
                  ...
                  child: DelayedDisplay(
                    delay: Duration(milliseconds: 500),
                    slidingBeginOffset: Offset(0, 2),
                    child: Text("Let us create an account so that your process will be saved",textAlign: TextAlign.center ,style: kTitleTextStyle.copyWith(color: Colors.white.withOpacity(0.5), fontSize: 18),),
                    fadingDuration: Duration(milliseconds: 700),
                    fadeIn: true,
                  ),
                ),
                ...
                Padding(
                  ...
                  child: DelayedDisplay(
                    ...
                    child: ArgonButton(
                      ...
                      color: Colors.white,
                      borderRadius: 5.0,
                      child: Text('Register', style: kSubTitleTextStyle.copyWith(color: Color(0xff1e6091)),),
                      loader: Container(
                      ...
                      onTap: (startLoading, stopLoading, btnState) async {
                          ...
                          if(emailController.text == "" && passwordController.text == ""){
                            ...
                            await FirebaseAuth.instance.createUserWithEmailAndPassword(email: emailController.text.trim(), password: passwordController.text.trim()).then((value){
                             ...
                             stopLoading();
                              _helperFunction.showToast(context: context, color: Colors.red, title: 'Failed to create user try again');
                            });
                          }
                          stopLoading();
